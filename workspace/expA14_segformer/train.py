...
def main() -> None:
    ...
    # CholecSeg8k 事前学習は fold ごとに別 ckpt を当てる
    if cfg["model"].get("use_cholec_pretrain"):
        cfg["model"]["cholec_fold"] = args.fold
