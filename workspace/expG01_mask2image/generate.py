...
def main():
    ...
    p.add_argument('--center', default='center_1', help='style token; use any centre seen in training')
    ...
    for i, f in enumerate(files):
        ...
        centre = a.center
        m = re.match(r'(center_\d+)', f.name)
        if m and a.labels.name == 'labels_fine_1024':
            centre = m.group(1)
        prompt = f'{centre} thoracoscopic esophagectomy surgical field'
        ...
        cond.save(a.output / f'{f.stem}_cond.png')
