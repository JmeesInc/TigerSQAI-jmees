...
def main():
    ...
    cfg=yaml.safe_load(a.config.read_text());a.output.mkdir(parents=True,exist_ok=True);batches=[]
    ...
    build(batches,a.output/'bank',cfg)
